...
def plot_divergence_horizontal(ds_sub, save_dir, interval_name, line, t0=None, sb_t0str=None, sb_t1str=None):
    t0 = t0 or None
    ...
    for hour_idx, hour in enumerate(hours):
        ...
        #ax.plot(lons_interp[elev_idx], ylims[0] * 1.4, 'ko')
...
def main(sDir, sdate, edate, intvl, line):
    ...
    if intvl == 'divergence_hourly_cases_horizontal_zoomed':
    ...
    if intvl == 'divergence_seabreeze_days_hourly_avg_zoomed':
