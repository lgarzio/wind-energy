...
from wrf import getvar, interplevel, default_fill, ALL_TIMES
...
def main(fdir, sdir):
    files = sorted(glob.glob(fdir + '/wrfout*'))
    for fname in files:
        ...
        save_name = 'wrfproc_{}_{}_00Z_H{:03d}.nc'.format(domain,
                                                          splitter[2].replace('-', ''),
...
if __name__ == '__main__':
    #file_dir = '/Users/garzio/Documents/rucool/bpu/wrf/windturbs/wrfout_windturbs/1kmctrl/20200730'  # 1kmrun  1kmctrl
    #file_dir = '/Users/garzio/Documents/rucool/bpu/wrf/goes_dineof_sst_runs/GOES_ruwrf_nest_20200730_00Z'
    #file_dir = '/Users/garzio/Documents/rucool/bpu/wrf/goes_dineof_sst_runs/original_20200731_00Z'
    file_dir = '/home/pareja/DINEOF_ruwrf_nest_20200728_00Z'
    save_dir = '/home/lgarzio/rucool/bpu/wrf/goes_dineof_sst_runs/DINEOF_ruwrf_nest_20200728_00Z/'
